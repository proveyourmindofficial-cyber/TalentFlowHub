...
import { initiateO365Login } from "@/hooks/useAuth";
          ...
          <CardContent className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Sign in with your Office 365 account to access the recruitment system
              </p>
            </div>

            <Button 
              onClick={initiateO365Login}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 h-auto"
              data-testid="button-office365-login"
            >
